...
> Lite scroll position spy for navigation

[![npm version](https://badge.fury.io/js/lite-scroll-spy.svg)](https://www.npmjs.com/package/lite-scroll-spy)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

## Installation

```bash
npm install lite-scroll-spy
```

## Quick Start

```javascript
const { spy } = require('lite-scroll-spy');
...
```javascript
const { spy, batch } = require('lite-scroll-spy');
